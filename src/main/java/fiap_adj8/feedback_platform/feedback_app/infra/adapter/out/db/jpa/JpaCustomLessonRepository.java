...
public class JpaCustomLessonRepository implements CustomLessonRepository {
    ...
    public JpaCustomLessonRepository(JpaLessonRepository jpaLessonRepository, JpaLessonMapper jpaLessonMapper) {
    ...
    public Optional<Lesson> findById(UUID id) {
        ...
        Optional<JpaLessonEntity> optionalJpaLessonEntity = jpaLessonRepository.findById(id);

...
public class FindFeedbackByIdForAdminUseCaseImpl implements FindFeedbackByIdForAdminUseCase {

    private final CustomFeedbackRepository customFeedbackRepository;

    public FindFeedbackByIdForAdminUseCaseImpl(CustomFeedbackRepository customFeedbackRepository) {
